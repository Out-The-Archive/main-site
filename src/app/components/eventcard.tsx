...
export default function EventCard({ coords, eventName, date, location, imgSrc, }: EventCardProps){
        ...
        >   
            ...
            <div
                className="bg-cover size-[65px] lg:size-[102.673px] xl:w-[113.851px] 
                            absolute overflow-visible z-20 top-[-10px] lg:top-[-20px]"
                style={{backgroundImage: 'url(/upcomingEvents/clothespin.svg)', transform: `rotate(${(Math.random() * 21) - 10}deg)`}}
            />
            ...
            <div 
                ...
                style={{transform: `rotate(${(Math.random() * 13) - 5}deg)`}}
            >   
                {/*cover*/}
                <img
                    src={imgSrc}
